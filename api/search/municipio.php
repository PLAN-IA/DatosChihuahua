<?php
// api/search/municipio.php - Endpoint para búsqueda por municipio
...
try {
    ...
    if (empty($municipio)) {
        ...
        echo json_encode(['error' => 'Parámetro name es requerido', 'timestamp' => date('Y-m-d H:i:s')]);
        exit;
    }
    ...
    error_log("Error en search/municipio: " . $e->getMessage());
