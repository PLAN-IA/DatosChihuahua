<?php
// api/search/cp.php - Endpoint específico para búsqueda de códigos postales
...
try {
    ...
    if (empty($query)) {
        ...
        echo json_encode(['error' => 'Parámetro query es requerido', 'timestamp' => date('Y-m-d H:i:s')]);
        exit;
    }
    ...
    error_log("Error en search/cp: " . $e->getMessage());
